  ...
  return (
    <div className="grid place-items-center bg-dark-main text-light-main">
      <div className="p-[4rem] 2xl:p-0 mx-auto flex flex-col lg:flex-row items-center">
        <h1 className="font-normal text-[2.5rem] xl:text-[3.3rem] 2xl:text-[3.7rem] leading-tight lg:max-w-[40rem] mb-10 lg:mb-0 lg:mr-[2.5rem]">
        ...
        <div className="flex flex-col gap-10 lg:max-w-[40rem] lg:ml-[3.5rem]">
          <InfoCard
